...
#define TIMER2_PRESCALER_SELECT(PRESCALER_VALUE)    (T2CONbits.T2CKPS = PRESCALER_VALUE)
#define TIMER2_POSTSCALER_SELECT(POSTSCALER_VALUE)  (T2CONbits.TOUTPS = POSTSCALER_VALUE)
